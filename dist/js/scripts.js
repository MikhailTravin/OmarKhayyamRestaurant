...
if (map) {
  ...
  function init() {
    ...
    myMap.geoObjects
      .add(new ymaps.Placemark([53.963166, 27.623770], {
...
const filterButtons = document.querySelectorAll('.block-menu__filter [data-filter]');
if (filterButtons) {
  ...
  filterCards('all');
  const allButton = document.querySelector('.block-menu__filter [data-filter="all"]');
